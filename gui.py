...
if df_original is not None:
    try:
        ...
        if view_type == get_text(lang, 'view_type_detailed'):
            ...
            # ******************************************************
            # * INICIO DE LA SOLUCIÓN (Spinner de UX)
            # ******************************************************
            #
            # Envolvemos la llamada a la vista detallada en un spinner.
            # CADA VEZ que el st.data_editor (dentro de esa función)
            # cause un rerun (al presionar Enter), el usuario verá
            # este mensaje. Esto le indica que "espere" a que termine
            # el guardado antes de editar la siguiente celda.
            #
            # (Asegúrate de tener 'spinner_saving' en tu archivo de traducciones,
            # o simplemente reemplaza el texto)
            #
