# modules/gui_views.py (VERSIÓN CORREGIDA v5, con fix de HASH ESTABLE)
...
def render_detailed_view(lang, resultado_df, df_original, col_map_ui_to_en, todas_las_columnas_en):
    ...
    # ******************************************************
    # * INICIO DE LA SOLUCIÓN (HASH ESTABLE)
    # ******************************************************
    
    # 2. Creamos un hash estable usando JSON para la lista de dicts
    # y una tupla para la lista de columnas.
    ...
    # ******************************************************
    # * FIN DE LA SOLUCIÓN (HASH ESTABLE)
    # ******************************************************
    ...
    # --- El Widget Data Editor (TU CÓDIGO ORIGINAL) ---
